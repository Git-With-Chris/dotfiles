...
> **Branches:** `dotfiles-macos`, `dotfiles-windows`, `dotfiles-linux` each
> carry only that platform. This branch is the trunk holding all three.
> Setup notes: [WINDOWS.md](WINDOWS.md) | [LINUX.md](LINUX.md)
